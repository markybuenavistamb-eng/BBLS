...
(function () {
  const DICT = {
    en: {
      ...
      'land.hero.sub': 'At Victors Freight International, we carry more than balikbayan boxes — we carry your love and care from anywhere in the world straight to your family’s doorstep in the Philippines, safely tracked every step of the way.',
      ...
      'intake.donePrint': 'Print / Save as PDF',
    ...
    tl: {
      ...
      'land.hero.sub': 'Sa Victors Freight International, higit pa sa mga balikbayan box ang dala namin — dala namin ang inyong pagmamahal at malasakit mula saanman sa mundo diretso sa pintuan ng inyong pamilya sa Pilipinas, ligtas na sinusubaybayan sa bawat hakbang.',
      ...
      'intake.donePrint': 'I-print / I-save as PDF',
