...
(function () {
  const DICT = {
    en: {
      ...
      'land.hero.sub': 'At Victors Freight International, we carry more than boxes — we carry your love and care from anywhere in the world straight to your family’s doorstep in the Philippines, safely tracked every step of the way.',
    ...
    tl: {
      ...
      'land.hero.sub': 'Sa Victors Freight International, higit pa sa mga kahon ang dala namin — dala namin ang inyong pagmamahal at malasakit mula saanman sa mundo diretso sa pintuan ng inyong pamilya sa Pilipinas, ligtas na sinusubaybayan sa bawat hakbang.',
