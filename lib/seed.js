...
function build() {
  ...
  const shipperAgent = mkUser('Grace Lim (Bangkok Office)', 'shipper@vfic.demo', 'SHIPPER_AGENT');
  ...
  // Senders (abroad — VFIC's primary lanes: Thailand, Vietnam, Cambodia)
  ...
  const sJose = mkCustomer('Jose Ramirez', '+84 90 555 0147', 'SENDER', { line: '128 Nguyen Hue Blvd, District 1', city: 'Ho Chi Minh City', country: 'Vietnam' });
  ...
  const sPedro = mkCustomer('Pedro Bautista', '+84 24 555 0126', 'SENDER', { line: '9 Hang Bong St, Hoan Kiem', city: 'Hanoi', country: 'Vietnam' });
  // Receivers (PH)
  ...
  const rBong = mkCustomer('Bong Ramirez', '+63 918 555 0202', 'RECEIVER', { line: 'Purok 4, National Hwy', brgy: 'Brgy Poblacion', city: 'San Fernando', prov: 'La Union', region: 'R1', landmark: 'Near San Fernando public market' });
  const rNene = mkCustomer('Nene Villanueva', '+63 919 555 0203', 'RECEIVER', { line: 'Blk 5 Lot 12, Camella Homes', brgy: 'Brgy Dela Paz', city: 'Biñan', prov: 'Laguna', region: 'R4A', landmark: 'White house with mango tree' });
  ...
  const rTess = mkCustomer('Teresita Gomez', '+63 921 555 0205', 'RECEIVER', { line: '19 Mabini St', brgy: 'Brgy Lahug', city: 'Cebu City', prov: 'Cebu', region: 'R7', landmark: 'Gate with bougainvillea' });
  const rDodong = mkCustomer('Dodong Uy', '+63 922 555 0206', 'RECEIVER', { line: 'Km 7 Diversion Rd', brgy: 'Brgy Buhangin', city: 'Davao City', prov: 'Davao del Sur', region: 'R11', landmark: 'Yellow sari-sari store in front' });
  ...
  const cStripped = {
    ...
    origin_port: 'Laem Chabang, Thailand', destination_port: 'Manila (MICP)',
  ...
  const cTransit = {
    ...
    origin_port: 'Ho Chi Minh City (Cat Lai), Vietnam', destination_port: 'Manila (MICP)',
  ...
  const sh2 = mkShipment(sJose, { created: daysAgo(50), fee: 340, origin: 'Vietnam', agent: 'Ho Chi Minh City' });
  ...
  const sh4 = mkShipment(sPedro, { created: daysAgo(47), origin: 'Vietnam', agent: 'Hanoi', fee: 300, currency: 'USD', paid: false });
  ...
  const sh6 = mkShipment(sJose, { created: daysAgo(20), fee: 480, origin: 'Vietnam', agent: 'Ho Chi Minh City' });
  ...
  const sh9 = mkShipment(sPedro, { created: daysAgo(6), origin: 'Vietnam', agent: 'Hanoi', fee: 200, currency: 'USD' });
  ...
  const sh11 = mkShipment(sJose, { created: daysAgo(40), fee: 960, origin: 'Vietnam', agent: 'Ho Chi Minh City' });
  ...
  d.box_orders.push({
    ...
    items: [{ size: 'XL', qty: 1 }], total_qty: 1,
