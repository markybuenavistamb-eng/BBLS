...
function build() {
  ...
  d.intake_requests.push({
    ...
    sender: {
      full_name: 'Elena Marquez', phone_primary: '+1 702 555 0119', phone_alternate: '',
      email: 'elena.marquez@example.com', address_line: '410 Desert Bloom Ave', city_municipality: 'Las Vegas', province: 'NV', country: 'USA'
    },
    origin_country: 'USA', origin_agent: 'Las Vegas', service_type: 'DOOR_TO_DOOR',
    shipping_fee_amount: null, currency: 'USD', payment_status: 'UNPAID',
    passport_file: null,
    boxes: [
      {
        receiver: { full_name: 'Fernando Marquez', phone_primary: '+63 923 555 0299', phone_alternate: '', address_line: '77 Malakas St', barangay: 'Brgy Pinyahan', city_municipality: 'Quezon City', province: 'Metro Manila', region: 'NCR', country: 'Philippines', landmark: 'Yellow gate near the chapel' },
        size_category: 'LARGE', weight_kg: null, length_cm: null, width_cm: null, height_cm: null,
        declared_contents: 'Clothes, canned goods, chocolates',
        special_instructions: 'Please call before delivering',
        packing_list_items: [{ description: 'Winter jackets', qty: '4 pcs' }, { description: 'Canned goods', qty: '15 cans' }]
      }
    ]
  });
