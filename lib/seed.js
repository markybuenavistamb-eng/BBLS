...
function build() {
  ...
  d.box_orders.push({
    ...
    delivery_method: 'DELIVER_ADDRESS',
    address: { region: 'R7', city_municipality: 'Cebu City', barangay: 'Brgy Lahug', street_address: '19 Mabini St', postal_code: '6000', landmark: 'Gate with bougainvillea' },
    contact: { name: 'Marites Solon', phone: '09175551188', email: 'marites.solon@example.com' }, notes: 'Please deliver on a weekend if possible.'
  });
  d.box_orders.push({
    id: nid('box_order'), reference_code: `BO-${YEAR}-000002`, status: 'PREPARING', submitted_at: daysAgo(3),
    items: [{ size: 'XL', qty: 1 }], total_qty: 1,
    delivery_method: 'PICKUP_OFFICE', address: null,
    contact: { name: 'Jerome Aquino', phone: '09285550042', email: '' }, notes: ''
  });
