...
const ORIGIN_PORTS = [
  ...
  { group: 'Southeast Asia', ports: ['Singapore', 'Port Klang, Malaysia', 'Tanjung Pelepas, Malaysia', 'Laem Chabang (Bangkok), Thailand', 'Bangkok, Thailand', 'Ho Chi Minh City, Vietnam', 'Jakarta, Indonesia'] },
...
module.exports = { SHIPPING_LINES, ORIGIN_PORTS, DESTINATION_PORTS };
