...
const FINANCE = {
  HQ_MANILA: {
    ...
    vat_label: 'VAT',
    fx_source: 'BSP Reference Exchange Rate Bulletin', fx_source_short: 'BSP',
  ...
  TH_BANGKOK: {
    ...
    vat_label: 'VAT',
    fx_source: 'Bank of Thailand exchange rates', fx_source_short: 'Bank of Thailand',
  ...
  KH_PHNOMPENH: {
    ...
    vat_label: 'VAT',
    fx_source: 'ACLEDA Bank exchange rates', fx_source_short: 'ACLEDA Bank',
