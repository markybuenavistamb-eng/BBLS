...
// Usable internal capacity per container type (industry standard figures).
...
const CONTAINER_CAPACITY = {
  C20:   { cbm: 33.2, payload_kg: 28200 },
  C40:   { cbm: 67.7, payload_kg: 26700 },
  C40HQ: { cbm: 76.4, payload_kg: 26500 }
};
