...
const SHIPPER_MODULES = ['dashboard', 'shipments', 'box_orders', 'boxes', 'containers', 'origin_warehouse', 'driver_passes', 'customers', 'sms', 'reports', 'scan'];
...
const DEFAULTS = {
  ...
  CONSIGNEE_AGENT: ['dashboard', 'shipments', 'box_orders', 'boxes', 'containers', 'ph_warehouse', 'trips', 'driver_passes', 'returns', 'customers', 'sms', 'reports', 'scan'],
