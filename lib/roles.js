...
// Roles that only exist at the Philippine end. A branch deployment has no use for them:
// nobody in Bangkok receives at the Manila warehouse or drives a delivery van.
const PH_ONLY_ROLES = ['CONSIGNEE_AGENT', 'WAREHOUSE'];
...
module.exports = {
  ...
  seesEveryShipment, shippedCargoOnly, SHIPPED_ONLY_ROLES, PH_ONLY_ROLES
};
